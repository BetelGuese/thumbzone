 ...
 * ports, because there is nothing to adopt: the markup is static HTML by the
 * time the browser sees it, and the module script that calls this is the only
 * thing that ever claims these elements. That absence is also why the demo route
 * can honestly publish an already-resolved `__thumbzoneReady`.
 */
 ...
 * behaviour will reach for. Both should fail here, at the call, naming what was
 * missing — not later, on a property access with no context.
 *
